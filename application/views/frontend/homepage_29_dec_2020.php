								...
								<div class="tab-pane fade" id="nav-profile" role="tabpanel">
										<div class="row videosContent heramieantes">
											...
											<div class="col-md-6 col-sm-12 col-xs-12 col-lg-4 col-xl-4 text-center">
												...
												<input type="hidden" id="slug" value="https://techspotpr.com/products/<?php if(isset($heram['handle'])){echo $heram['handle'];} ?>?pr_prod_strat=collection_fallback&pr_rec_pid=<?php if(isset($heram['id'])){echo $heram['id'];}  ?>">
											</div>
											<?php  } } ?>
										</div>
								</div>
		...
		<div class="tab-pane fade" id="navSetting" role="tabpanel">
				...
				<div class="row videosContent ToolsSetting text-center">
					...
					<div class="col-md-6 ToolsContent col-lg-4 col-xl-4 col-sm-12 col-xs-12 text-center toolsPage">
						...
						<input type="hidden" id="slug" value="https://techspotpr.com/products/<?php if(isset($video['handle'])){echo $video['handle'];} ?>?pr_prod_strat=collection_fallback&pr_rec_pid=<?php if(isset($video['id'])){echo $video['id'];}  ?>">
