...
<div class="invoice section">
	<table>
		...
		<tr>
			...
			<th style="width: 50%;text-align: center;">Carrier</th>
			<th style="width: 50%;text-align: center;">IMEI</th>
		</tr>
		</thead>
		<tbody>
		<tr>
...
<div class="invoice section">
	<table>
		<thead>
		<tr>
			<th style="width: 50%;text-align: center;">Device</th>
		...
		?>
		<tr>
			<td class="item-stock"><?php if(isset($item['item'])){ echo  $item['item']; } ?></td>
			<td class="item-qty"><?php if(isset($currency)) { echo $currency; }  ?><?php if(isset($item['unit'])){ echo  $item['unit']; } ?></td>
			<td  class="item-price"><?php if(isset($currency)) { echo $currency; }  ?><?php if(isset($item['total'])){ echo  $item['total']; } ?></td>
		</tr>
		<?php } } ?>
		</tbody>
		...
		<!-- <tr class="text-offset">
			...
			<td><?php if(isset($currency)) { echo $currency; }  ?><?php if(isset($total_amount)){ echo $total_amount; } ?></td>
		</tr> -->
		<tr class="text-offset">
			<td colspan="1" style="border: none;background: #fff;text-align: left;"><?php if(isset($sales_notes)){ echo 'Notes'; } ?></td>
		...
		<tr class="text-offset">
			<td colspan="1" style="border: none;background: #fff;text-align: left;">
