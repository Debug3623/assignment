...
<head>
  ...
  <title>Restaurant POS Glowingsoft</title>
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <li class="nav-item dropdown" id="notification">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="order" class="nav-link" style="color: #fff;background-color: #dc3545;border-color: #dc3545;box-shadow: none;padding: .125rem .25rem;font-size: .75rem;line-height: 1.5;border-radius: .15rem; height:23px; margin-top:10px;">New Order</a>
        </li>
        <li class="nav-item">
